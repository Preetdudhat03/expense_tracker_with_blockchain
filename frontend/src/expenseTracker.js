...
const loadBlockchainData = async () => {
    ...
    try {
        ...
        // Get the deployed contract from the ABI and network ID
        ...
        console.log(`✅ Connected to contract at ${deployedNetwork.address} on network ID ${networkId}`);

        // Return the contract instance and the user's account
